...
class MusicPlayer extends Component {
  ...
  handleClickMusicList=(index)=>{
    this.setState({activeMusicIndex:index})
  }
    ...
    return (
      <div className="player-container" style={this.props.style}>
        ...
        <div className="list-container">         {this.props.playlist.map((music,index)=>{
          return(
            <div key={index} className="list-item" onClick={() => this.handleClickMusicList(index)}>{music.title}</div>
          )
        })}</div>
