      ...
      <Container>
        <Row>
          ...
          <Col xs={6} md={5}>
            ...
            <br></br>
            <a href='https://github.com/Ding-x'><i className="fab fa-github self-icon" ></i></a>
            <a href='https://www.linkedin.com/in/xiaopeng0202/'><i className="fab fa-linkedin self-icon"></i></a>
            <a href='https://music.163.com/#/artist?id=12027469'><i className="fas fa-headphones self-icon"></i></a>
          </Col>
        </Row>
      </Container>
      </div>
